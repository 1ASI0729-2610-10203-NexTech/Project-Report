...
~~~C#
string[] EquipoNexTech() {
    return new string[] {
        "🧑‍💻 Pacheco Lavado, Rafael Agustin - U202014215",
        "🧑‍💻 Mendoza Moreano, Mariel Lucero  - U20231a418",
        "🧑‍💻 Díaz Yurivilca, Sofía  - U20241A195",
        "🧑‍💻 Rengifo Lozano, David  - U20221022",
        "🧑‍💻 Villón Amez, Enrique  - U20161a304"
    };
}
~~~
...
<table>
  ...
  <tr>
    ...
    <td>
      <ul> 
        <li>Pacheco Lavado, Rafael Agustin</li> 
        <li>Mendoza Moreano, Mariel Lucero</li> 
        <li>Díaz Yurivilca, Sofía </li>
        <li>Rengifo Lozano, David</li>
        <li>Villón Amez, Enrique</li>
      </ul>
    </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <strong>ℹ️ AV1:</strong><br>
        Participé en el desarrollo del proyecto cumpliendo con las tareas asignadas dentro del equipo. Contribuí a la elaboración de entregables clave como el Lean UX Process y los análisis de usuario. Cumplí con los objetivos asignados dentro de los plazos establecidos.<br>
      </td>
    </tr>
    <tr>
      <td>Díaz Yurivilca, Sofía</td>
...
BioTrack es un startup del sector HealthTech que ofrece un servicio integral de gestión nutricional a través de una plataforma web, dirigido a pacientes y organizaciones. A diferencia de modelos intermediarios, cuenta con un equipo interno de nutricionistas que brinda atención continua, permitiendo un seguimiento centralizado y confiable. 

La plataforma permite gestionar planes alimenticios personalizados, registrar el progreso de los pacientes y visualizar su evolución mediante gráficos y reportes. Además, las organizaciones acceden a dashboards con información del estado de salud de sus colaboradores, facilitando la implementación de programas de bienestar. 

El servicio opera bajo un modelo de suscripción escalable, adaptado a clientes individuales (B2C) y corporativos (B2B). Como proyección tecnológica, contempla la integración de IoT para optimizar la recolección de datos y mejorar la precisión del monitoreo. 

 

**Visión:** Ser la plataforma líder en gestión nutricional digital a nivel regional, reconocida por mejorar el bienestar de las personas y organizaciones mediante soluciones tecnológicas accesibles, eficientes y basadas en datos. 

**Misión:** Facilitar la interacción y el seguimiento nutricional entre especialistas y pacientes mediante herramientas digitales integradas, seguras y automatizadas, promoviendo la salud preventiva a través del uso de información confiable para la toma de decisiones. 
...
En la actualidad, la gestión de la salud y el bienestar se ha vuelto una prioridad tanto para individuos como para organizaciones; sin embargo, el seguimiento nutricional profesional enfrenta barreras significativas debido a la desconexión entre la consulta y la vida cotidiana del paciente. Históricamente, el monitoreo del progreso se ha basado en registros manuales y reportes subjetivos que suelen carecer de precisión, lo que dificulta la toma de decisiones clínicas informadas por parte de los nutricionistas. Esta ineficiencia se traduce en una pérdida de motivación para el paciente y una falta de datos accionables para las empresas que buscan promover una cultura de salud preventiva. Frente a esta problemática, BioTrack surge como una solución tecnológica que permite centralizar y automatizar la recolección de datos nutricionales mediante una plataforma web.
...
El problema radica en los métodos ineficientes de recolección de datos nutricionales, que impiden un seguimiento preciso del progreso del paciente. La falta de cumplimiento es la primera causa de fracaso clínico; de hecho, la Organización Mundial de la Salud (OMS) advierte que la adherencia a largo plazo en pacientes con enfermedades crónicas comprende poco más del 50% (Ortega Cerda et al., 2018).

- **¿Qué consecuencias tiene?**

Esta falta de control produce un estancamiento en los resultados de salud y una alta tasa de abandono de las dietas. Para las organizaciones, esto se traduce en una pérdida de la inversión en programas de bienestar al no lograr un impacto real, ya que el patrón alimentario inadecuado disminuye directamente la capacidad productiva de los trabajadores (Bejarano Roncancio & Díaz Beltrán, 2012).

##### 🟡 WHEN (¿Cuándo?)

- **¿Cuando sucede el problema?**   

El problema ocurre en el "punto ciego" entre cada consulta nutricional (generalmente de 15 a 30 días), cuando no existe un monitoreo continuo. El registro personal de la ingesta dietética es valioso, pero la evidencia demuestra que el auto-monitoreo decae rápidamente con el tiempo si no se utilizan estrategias interactivas (Patel et al., 2019).

- **¿Cuando utiliza el cliente el producto?**

El paciente utiliza la plataforma diariamente para registrar sus comidas de forma ágil. Por su parte, el nutricionista y el administrador corporativo lo utilizan durante sus jornadas laborales para revisar alertas de adherencia y reportes estadísticos, respectivamente.

##### 🟡 WHERE (¿Dónde?)

- **¿Dónde se presenta el problema?** 

En consultorios nutricionales, clínicas de bienestar y departamentos de Recursos Humanos corporativos que dependen de registros físicos o software local que no permite la movilidad ni el análisis de datos en tiempo real.

- **¿Dónde se usa el producto?** 

La aplicación web es un entorno Cloud, utilizable desde cualquier dispositivo con acceso a internet, permitiendo que los pacientes registren sus datos desde su hogar y los profesionales gestionen la información desde sus oficinas.

##### 🟡 WHO (¿Quién?)

- **¿Quién tiene este problema?**   

Pacientes que se desmotivan por falta de seguimiento continuo, nutricionistas que pierden tiempo valioso en tareas administrativas manuales, y organizaciones que invierten en salud corporativa sin obtener métricas claras de su impacto.

- **¿Quién se beneficia del producto?** 

El ecosistema de BioTrack beneficia a tres actores principales: El Paciente (usuario final), el Nutricionista (profesional clínico) y el Administrador Corporativo (RRHH).

##### 🟡 WHY (¿Por qué?)

- **¿Por qué ocurre el problema?** 

Porque la industria de la nutrición tradicional no ha integrado herramientas digitales de uso diario. Se depende de la memoria del paciente o de hojas de cálculo aisladas, métodos manuales que experimentan un rápido declive en su uso por parte del paciente (Patel et al., 2019).

- **¿Por qué es importante automatizar?**

Porque reduce el margen de error humano y permite un seguimiento preventivo. La digitalización facilita el auto-monitoreo constante a través de aplicaciones, lo cual es una estrategia comprobada para mantener el compromiso del usuario y pasar de un modelo reactivo a uno proactivo (Patel et al., 2019).

##### 🟡 HOW (¿Cómo?)

- **¿Cómo soluciona el producto el problema?**

BioTrack proporciona un entorno web de múltiples Bounded Contexts. A los pacientes les ofrece un registro diario (Daily Log) intuitivo; a los nutricionistas, un panel centralizado con alertas de riesgo; y a las empresas, un Dashboard con métricas de salud poblacional totalmente anónimas para respetar la privacidad médica.

##### 🟡 HOW MUCH (¿Cuánto?)

- **¿Cuánto le cuesta este problema a la sociedad/empresas?**  

La mala alimentación incrementa de forma acelerada el desarrollo de enfermedades crónicas, lo que no solo aumenta los costos directos de atención en salud, sino que impacta negativamente a las empresas al disminuir la capacidad productiva de los trabajadores (Bejarano Roncancio & Díaz Beltrán, 2012).

- **¿Cuánto costaría implementar la solución propuesta?**

  - Desarrollo Web (Frontend y Backend): S/ 20,000 - S/ 35,000

  - Integración de Pasarela de Pagos B2B/B2C: S/ 3,000 - S/ 5,000

  - Diseño de Arquitectura UX/UI: S/ 4,000 - S/ 8,000

  - Infraestructura Cloud y Base de Datos (Anual): S/ 1,500 - S/ 3,000
...
#### 2.1.1. 	Análisis competitivo 
  ...
  <tr>
    <td valign="top"><img src="resources/Chapter-II/BiotrackLogo.png" alt="Logo Mi Startup" height="100px"></td>
    <td valign="top"><img src="https://upload.wikimedia.org/wikipedia/en/6/63/MyFitnessPal_Logo.png" alt="Logo Bsale" height="100px"></td>
    <td valign="top"><img src="https://play-lh.googleusercontent.com/QqbWLtHPocHrgg03WyNqfmxVMBEEnvdavkz5xkdjwrr1MEpkez6f76_hsqxiTbg18M20oqN_k_DVlbG7C7s7kw=w240-h480-rw" alt="Logo Defontana" height="100px"></td>
    <td valign="top"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Fitbit_logo16.svg/1920px-Fitbit_logo16.svg.png" alt="Logo Excel" height="100px"></td>
   </tr>
  <tr>
...
<table>
  ...
  <tr>
    <td colspan="2">
      <img src="resources/Chapter-II/EntrevistaCath.png" alt="Entrevista Catherine Villar">
    </td>
  </tr>

  <tr>
    <td>
      <strong>Entrevistado:</strong> Catherine Villar<br>
      <strong>Entrevistador(a):</strong> Sofía Díaz Yurivilca<br>
      <strong>Duración:</strong> 7:16
    </td>
    <td>
      <strong>Género:</strong> Femenino<br>
...
<table>
  ...
  <tr>
    <td colspan="2">
      <img src="resources/Chapter-II/EntrevistaGonzalo.png" alt="Entrevista Gonzalo">
    </td>
  </tr>

  <tr>
    <td>
      <strong>Entrevistado:</strong>Gonzalo Daniel Alberto de la Cruz Pérez<br>
      <strong>Entrevistador(a):</strong> Sofía Díaz Yurivilca<br>
  ...
  <tr>
    <td colspan="2">
      <strong>Link de la entrevista:</strong> 
      <a href="https://upcedupe-my.sharepoint.com/:v:/g/personal/u20241a195_upc_edu_pe/IQABDZdfcO6bQ46rgVqAyjtxAVl_jvHtLZ9r4i_Ro9mmjGM?e=mdaG9T">NexTech Entrevista 2</a>
    </td>
  </tr>
...
<table>
  ...
  <tr>
    <td colspan="2">
      <img src="resources/Chapter-II/EntrevistaSebas.png" alt="Entrevista Sebastian Curay">
    </td>
  </tr>

  <tr>
    <td>
      <strong>Entrevistado:</strong>Sebastian Curay<br>
      <strong>Entrevistador(a):</strong> Sofía Díaz Yurivilca<br>
      <strong>Duración:</strong> 7:16
    </td>
    <td>
      <strong>Género:</strong>Masculino<br>
      <strong>Edad:</strong> 21<br>
      <strong>Lugar de Residencia:</strong> San Martín de Porres
    </td>
  </tr>
  ...
  <tr>
    <td colspan="2">
      <strong>Link de la entrevista:</strong> 
      <a href="https://upcedupe-my.sharepoint.com/:v:/g/personal/u20241a195_upc_edu_pe/IQBJhEtjNKlNQpfpZOzA6WyMAegaGqWau48Z__B5YwZbBIQ?e=GKIWgv">NexTech Entrevista 3</a>
    </td>
  </tr>
...
<table>
  ...
  <tr>
    <td colspan="2">
      <img src="resources/Chapter-II/EntrevistaAntonio.png" alt="Entrevista Antonio Cortez ">
    </td>
  </tr>

  <tr>
    <td>
      <strong>Entrevistado:</strong> Antonio Cortez<br>
      <strong>Entrevistador(a):</strong> Sofía Díaz Yurivilca<br>
      <strong>Duración:</strong> 5:45
    </td>
    <td>
      <strong>Género:</strong>Masculino<br>
      <strong>Edad:</strong> 29<br>
  ...
  <tr>
    ...
    El entrevistado representa a una empresa que actualmente promueve la salud de sus colaboradores mediante campañas internas, chequeos médicos, pausas activas y talleres; sin embargo, reconoce limitaciones en el seguimiento, el cual es básico y no continuo.
      
    Identifica problemas como mala alimentación, sedentarismo y altos niveles de estrés que afectan el rendimiento laboral.Aunque han probado herramientas digitales, estas no se han adaptado completamente a sus necesidades debido a su complejidad. Destaca la importancia de contar con información actualizada y en tiempo real para la toma de decisiones.
 ...
 <table>
  ...
  <tr>
    <td colspan="2">
      <img src="resources/Chapter-II/EntrevistaPamela.png" alt="Entrevista Pamela Beltran">
    </td>
  </tr>

  <tr>
    <td>
      <strong>Entrevistado:</strong>Pamela Beltran<br>
      <strong>Entrevistador(a):</strong> Sofía Díaz Yurivilca<br>
  ...
  <tr>
    <td colspan="2">
      <strong>Link de la entrevista:</strong> 
      <a href="https://upcedupe-my.sharepoint.com/:v:/g/personal/u20241a195_upc_edu_pe/IQCbuYwJkTaeSbZpYfVeD4X5AU9aCf1qY23KaTRko4epAJw?e=xXpp0c">NexTech Entrevista 5 
     </a>
    </td>
  </tr>
 ...
 <table>
  ...
  <tr>
    <td colspan="2">
      <img src="resources/Chapter-II/EntrevistaCarlos.png" alt="Entrevista Sebastian Curay">
    </td>
  </tr>

  <tr>
    <td>
      <strong>Entrevistado:</strong> Carlos Geldres<br>
      <strong>Entrevistador(a):</strong> Sofía Díaz Yurivilca<br>
...
| US37 | Emitir y limitar factura corporativa | Como Admin Corporativo, quiero recibir una factura detallada por la compra del paquete de licencias, para contar con el documento formal necesario para los registros contables de mi empresa. | **Scenario 1: Factura emitida correctamente**<br>Given el pago corporativo ha sido confirmado,<br>When el sistema procesa la emisión de la factura,<br>Then el sistema genera y emite la factura con el detalle del paquete adquirido, el monto y los datos de la empresa verificada.<br><br>**Regla de negocio:** La factura solo se emite una vez confirmado el pago y está limitada al monto y cantidad de licencias del paquete seleccionado. | EP05 |
| US38 | Procesar renovación mensual automática exitosa | Como Sistema, quiero procesar automáticamente la renovación mensual de los planes activos cuando el cobro es exitoso, para garantizar la continuidad del servicio sin intervención manual. | **Scenario 1: Renovación automática exitosa**<br>Given un plan de suscripción está próximo a vencer,<br>When el sistema ejecuta el cobro automático y el Pasarela de Pagos API lo procesa exitosamente,<br>Then el sistema extiende la vigencia del plan, la suscripción queda como "renovada" y el usuario mantiene acceso a todos los beneficios. | EP05 |
| US39 | Suspender funciones premium por pago atrasado | Como Sistema, quiero suspender automáticamente las funciones premium del usuario cuando el cobro de renovación falla, para gestionar los pagos atrasados y notificar al usuario oportunamente. | **Scenario 1: Suspensión por cobro fallido**<br>Given el sistema intenta el cobro automático de renovación mensual,<br>When el cobro automático falla,<br>Then el sistema suspende el acceso a las funciones premium del usuario y lo notifica con un aviso de pago atrasado vía Email API.<br><br>**Scenario 2: Reactivación tras pago regularizado**<br>Given el usuario tiene el acceso premium suspendido por pago atrasado,<br>When regulariza su pago exitosamente,<br>Then el sistema reactiva las funciones premium y envía una confirmación de reactivación al usuario. | EP05 |
| US40 | Recibir aviso de pago atrasado | Como usuario, quiero recibir un aviso por correo cuando mi pago de renovación haya fallado, para poder regularizar mi situación y evitar la pérdida del acceso a los servicios premium. | **Scenario 1: Aviso recibido correctamente**<br>Given el sistema ha suspendido las funciones premium del usuario por cobro fallido,<br>When el Email API procesa el envío del aviso,<br>Then el usuario recibe un correo con el detalle del pago atrasado, el monto adeudado y las instrucciones para regularizar el pago.<br><br>**Scenario 2: Fallo en envío del aviso**<br>Given el sistema intenta enviar el aviso de pago atrasado,<br>When el Email API devuelve un error,<br>Then el sistema registra el fallo y reintenta el envío según la política de reintentos definida. | EP05 |
| EP06 | Landing Page — Sitio web estático con contenido segmentado para visitantes generales, pacientes individuales, empresas corporativas y nutricionistas. Incluye acciones de conversión y vínculo con la plataforma web. |  
| US41 | Visualizar propuesta de valor en la landing page | Como visitante, quiero visualizar la propuesta de valor de la plataforma en la landing page, para entender qué servicios ofrece y decidir si me registro. | **Scenario 1: Contenido visible y completo**<br>Given el visitante accede a la landing page,<br>When la página carga correctamente,<br>Then el visitante puede ver las secciones de propuesta de valor, beneficios clave y características principales de la plataforma.<br><br>**Scenario 2: Visualización en dispositivo móvil**<br>Given el visitante accede a la landing page desde un dispositivo móvil,<br>When la página carga,<br>Then el contenido se adapta correctamente al tamaño de pantalla (diseño responsive) sin pérdida de información relevante. | EP06 |
| US42 | Visualizar sección para pacientes individuales | Como visitante del segmento paciente, quiero ver el contenido específico para pacientes individuales en la landing page, para evaluar si la plataforma cubre mis necesidades de salud y nutrición. | **Scenario 1: Sección de pacientes accesible**<br>Given el visitante del segmento paciente navega a la sección correspondiente de la landing page,<br>When accede a dicha sección,<br>Then el sistema muestra características, beneficios y planes disponibles dirigidos a pacientes individuales, junto con un CTA claro para iniciar el registro.<br><br>**Scenario 2: Navegación a registro desde CTA**<br>Given el visitante del segmento paciente visualiza el CTA de registro,<br>When hace clic en él,<br>Then el sistema redirige al visitante a la pantalla de registro de cuenta de usuario. | EP06 |
| US43 | Visualizar sección para empresas corporativas | Como visitante del segmento empresa, quiero ver el contenido específico para organizaciones corporativas en la landing page, para evaluar si la plataforma es adecuada para implementar en mi empresa. | **Scenario 1: Sección corporativa accesible**<br>Given el visitante del segmento empresa navega a la sección corporativa de la landing page,<br>When accede a dicha sección,<br>Then el sistema muestra características, beneficios y planes corporativos disponibles, con un CTA para contactar ventas o iniciar el registro corporativo.<br><br>**Scenario 2: Navegación a registro corporativo desde CTA**<br>Given el visitante del segmento empresa visualiza el CTA de registro corporativo,<br>When hace clic en él,<br>Then el sistema redirige al visitante a la pantalla de registro de datos de empresa. | EP06 |
...
| TS04 | API: Endpoints de gestión del perfil de salud del paciente | Como Developer, quiero consumir los endpoints de perfil de salud del paciente, para registrar, consultar y actualizar los datos de salud, objetivos y restricciones alimentarias desde el cliente. | **Scenario 1: Registro de datos de salud — 201 Created**<br>Given el Developer envía POST /api/v1/patients/{id}/health-profile con token de paciente válido y datos de salud,<br>When el servidor procesa la solicitud,<br>Then el servidor responde con HTTP 201 y el perfil de salud creado.<br><br>**Scenario 2: Consulta de perfil — 200 OK**<br>Given el Developer envía GET /api/v1/patients/{id}/health-profile con token válido,<br>When el servidor procesa la solicitud,<br>Then el servidor responde con HTTP 200 y los datos del perfil de salud del paciente.<br><br>**Scenario 3: Sin autorización — 401 / 403**<br>Given el Developer envía una solicitud sin token o con token de un rol no autorizado,<br>When el servidor verifica la autenticación y autorización,<br>Then el servidor responde con HTTP 401 o HTTP 403. | EP07 |
| TS05 | API: Endpoints de gestión de planes nutricionales | Como Developer, quiero consumir los endpoints de planes nutricionales, para crear, consultar, actualizar y cambiar el estado de los planes desde el cliente. | **Scenario 1: Creación de plan — 201 Created**<br>Given el Developer envía POST /api/v1/nutritional-plans con token de nutricionista válido,<br>When el servidor procesa la solicitud,<br>Then el servidor responde con HTTP 201 y el plan con estado "propuesto".<br><br>**Scenario 2: Aceptación del plan — 200 OK**<br>Given el Developer envía PATCH /api/v1/nutritional-plans/{id}/accept,<br>Then el plan pasa a "activado".<br><br>**Scenario 3: Plan no encontrado — 404** | EP07 |
| TS06 | API: Endpoints de registro de progreso del paciente | Como Developer, quiero consumir los endpoints de seguimiento de progreso, para registrar el consumo de alimentos, actividad física y peso semanal del paciente desde el cliente. | **Scenario 1: Registro consumo — 201**<br>POST food-log<br><br>**Scenario 2: Actividad — 201**<br>POST activity-log<br><br>**Scenario 3: Peso — 200**<br>PATCH weight | EP07 |
| TS07 | API: Endpoints de suscripciones y pagos | Como Developer, quiero consumir los endpoints de suscripciones y pagos, para gestionar la contratación de planes, el procesamiento de pagos y el estado de las suscripciones desde el cliente. | **Scenario 1: Pago exitoso — 200**<br>Then suscripción activa<br><br>**Scenario 2: Pago rechazado — 402**<br>Then error pago<br><br>**Scenario 3: Consulta — 200** | EP07 |
...
- Ortega Cerda, J. J., Sánchez Herrera, D., Rodríguez Miranda, Ó. A., & Ortega Legaspi, J. M. (2018). Adherencia terapéutica: un problema de atención médica. Acta médica grupo Ángeles, 16(3), 226-232. Recuperado de [https://www.scielo.org.mx/scielo.php?pid=S1870-72032018000300226&script=sci_arttext](https://www.scielo.org.mx/scielo.php?pid=S1870-72032018000300226&script=sci_arttext)
